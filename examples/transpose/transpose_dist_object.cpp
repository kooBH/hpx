...
///////////////////////////////////////////////////////////////////////////
/// This is an example of distributed matrix transposition using
/// dist_object which uses HPX component.
///
            ...
            for (std::uint64_t phase : phase_range)
            {
                ...
                if (blocks_start <= phase && phase < blocks_end)
                {
                    phase_futures.push_back(hpx::async(&transpose_local,
                        A[from_block], A_offset, B[b], B_offset, block_size,
                ...
                else
                {
                    phase_futures.push_back(hpx::dataflow(&transpose,
                        A[b].fetch(from_locality), A_offset, B[b], B_offset,
