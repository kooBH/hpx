...
void add_op(int& local, hpx::future<int> remote)
{
    local += remote.get();
}
...
void run_dist_object_matrix_all_to_all()
{
    ...
    dist_object<myMatrixDouble> LHS("m1", lhs, c_t::All_to_All);
    dist_object<myMatrixDouble> RHS("m2", rhs, c_t::All_to_All);
    dist_object<myMatrixDouble> RES("m3", res, c_t::All_to_All);
...
void run_dist_object_matrix_mo()
{
    ...
    dist_object<myMatrixInt> M1("M1_meta", m1, c_t::Meta_Object);
    dist_object<myMatrixInt> M2("M2_meta", m2, c_t::Meta_Object);
    dist_object<myMatrixInt> M3("M3_meta", m3, c_t::Meta_Object);
...
void run_dist_object_matrix_mul()
{
    ...
    dist_object<myMatrixInt> M1(
        "M1_meta_mat_mul", all_data_m1[here], c_t::Meta_Object);
    dist_object<myMatrixInt> M2(
        "M2_meta_mat_mul", all_data_m2[here], c_t::Meta_Object);
    dist_object<myMatrixInt> M3(
        "M3_meta_mat_mul", here_data_m3, c_t::Meta_Object);
